...
**Genre Distribution:** Compared movie counts and revenue share across genres to identify top-performing categories.

**Rating & Votes Impact:** Used scatter and bubble charts to analyze how higher ratings and audience votes correlate with revenue.

**Runtime Analysis:** Explored how movie duration affects popularity and sales outcomes.
...
- Stacked Column Chart: To compare movie releases and revenues across genres.

- Scatter (Bubble) Chart with Play Axis: To examine how revenue changes with rating, votes, and runtime over time.
...
- Action and Adventure genres dominate total box office revenue.

- Average runtime (120–150 mins) correlates with better revenue performance.

- A steady growth trend in global box office revenue was observed over recent years.

Key Influencer Visual: To identify data-driven insights on what factors most affect revenue.
